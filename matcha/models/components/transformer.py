## Github[transformer.py]: https://github.com/shivammehta25/Matcha-TTS/blob/main/matcha/models/components/transformer.py
...
# source: https://huggingface.co/docs/diffusers/v0.9.0/en/index
...
class SnakeBeta(nn.Module):
    ...
    def __init__(self, in_features, out_features, alpha = 1.0, alpha_trainable = True, alpha_logscale = True):
        ...
        if self.alpha_logscale:
            ...
            # Linear sclae alphas initialized to ones
...
class FeedForward(nn.Module):
    ...
    def __init__(self, 
        ...
        ## FF as used in VisionTransformer, MLP-Mixer, etc. hace a final Drpoout
        if final_dropout:
            self.net.append(nn.Dropout(dropout))
...
class BasicTransformerBlock(nn.Module):
    ...
    def __init__(self,
                 ...
                 attention_head_dim: int,  ## d_model // n_heads
                 dropout = 0.0,
        ...
        if norm_type in ("ada_norm", "ada_norm_zero") and num_embeds_ada_norm is None:
            raise ValueError(
                f"'norm_type' us set to {norm_type}, but 'num_embeds_ada_norm' is not defined. Please make sure to define 'num_embeds_ada_norm' if setting 'norm_type' to {norm_type}."
                )
        ...
        if cross_attention_dim is not None or double_self_attention:
            ...
            I.e. the number of returned modulation chunks from AdaLayerZero would not make sense if returned during the second cross attention block.
            """
            ...
            self.attn2 = Attention( query_dim = dim,
                                    cross_attention_dim = cross_attention_dim if double_self_attention else None,
                                    heads = num_attention_heads,
                                    dim_head = attention_head_dim,
                                    dropout = dropout,
                                    bias = attention_bias,
